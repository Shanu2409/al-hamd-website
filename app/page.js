            ...
            >
              ...
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-4 py-4 sm:p-6 flex-shrink-0 relative">
                ...
                <div className="flex items-center space-x-3 pr-12">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">{selectedCategory.title}</h3>
                    <p className="text-amber-100 text-sm sm:text-base">{selectedCategory.description}</p>
                  </div>
                </div>
              </div>            {/* Scrollable Content with better mobile spacing */}
              ...
              <div className="p-4 sm:p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  {selectedCategory.products.map((product, index) => (
                    <motion.div
                      key={index}
                      className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-6 rounded-xl hover:shadow-lg transition-all duration-200"
                    ...
                    >                      <div className="bg-gradient-to-br from-amber-100 via-orange-100 to-amber-100 h-48 sm:h-52 md:h-48 rounded-lg mb-4 flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
                        <motion.button
                          ...
                          className="flex-1 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white py-3 px-4 rounded-lg flex items-center justify-center space-x-2 transition-all duration-200 text-sm font-medium min-h-[48px] touch-manipulation"
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                        >
                        ...
                        <motion.button
                          onClick={handleCall}
                          className="flex-1 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-white py-3 px-4 rounded-lg flex items-center justify-center space-x-2 transition-all duration-200 text-sm font-medium min-h-[48px] touch-manipulation"
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                        >
                ...
                {/* Additional padding at bottom for mobile */}
